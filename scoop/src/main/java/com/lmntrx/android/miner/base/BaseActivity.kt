...
import com.lmntrx.android.miner.widget.SwipeBackLayout
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    private fun getContainer(): View {
        ...
        ivShadow.setBackgroundColor(ContextCompat.getColor(this, R.color.swipe_back_bg))
    ...
    open fun createView(): View {
        ...
        mRootView.setBackgroundColor(ContextCompat.getColor(this,R.color.md_white_1000))
